...
export function saveOutlets(outlets: StoreOutlet[]): void {
  ...
  upsertDocuments(COLLECTIONS.OUTLETS, outlets).catch(console.warn);
}
...
export function deleteOutlet(outletId: string): StoreOutlet[] {
  ...
  deleteDocument(COLLECTIONS.OUTLETS, outletId).catch(console.warn);
  return filtered;
}
...
export function saveChannels(channels: SalesChannel[]): void {
  ...
  upsertDocuments(COLLECTIONS.CHANNELS, channels).catch(console.warn);
}
...
export function deleteChannel(channelId: string): SalesChannel[] {
  ...
  deleteDocument(COLLECTIONS.CHANNELS, channelId).catch(console.warn);
  return filtered;
}
