...
export const SAMPLE_PRODUCTS: Product[] = [
  ...
  {
    id: 'prod-motif-premium',
    sku: 'AQM-HJB-1004',
    barcode: '89910010004',
    name: 'Motif Premium Standar',
    category: 'Hijab',
    subCategory: 'Segi Empat Motif',
    images: [
    ...
    initialStock: 8,
    incomingStock: 20,
    outletStocks: { 'outlet-main': 22 },
    minStockAlert: 5,
    unit: 'Pcs',
    notes: 'Motif printing eksklusif bahan voal ultrafine',
    createdAt: '2026-08-01T08:00:00.000Z',
  },
  {
    id: 'prod-3',
